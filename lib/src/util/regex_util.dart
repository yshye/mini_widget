...
//
//   /// 自然数
//   static const String regexAllNumber = r'^(\-|\+)?\d+(\.\d+)?$';
//
//   /// 正数
...
//   static bool checkPwd(String input, [int min = 10, int max = 20]) {
//     return matches(r'(?=.*?[A-Z])', input) &&
//         matches(r'(?=.*?[a-z])', input) &&
//         matches('(?=.*?[0-9]).{$min,$max}', input);
//   }
//
//   /// 是否是数字
//   static bool isNumber(String input) {
//     return matches(regexAllNumber, input);
//   }
//
//   /// 是否是正数
//   static bool isPositiveNumber(String input) {
//     return matches(regexPositiveNumber, input);
//   }
//

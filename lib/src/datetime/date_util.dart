...
//   ZH_YEAR_MONTH_DAY_WORK, //yyyy年MM月dd日 星期w
// }
//
...
//   static String ymd_hm = "yyyy-MM-dd HH:mm";
//   static String ymd = "yyyy-MM-dd";
//   static String ym = "yyyy-MM";
//   static String md = "MM-dd";
//   static String md_hm = "MM-dd HH:mm";
//   static String hms = "HH:mm:ss";
//   static String hm = "HH:mm";
//
//   static String zh_full = "yyyy年MM月dd日 HH时mm分ss秒";
//   static String zh_ymd_hm = "yyyy年MM月dd日 HH时mm分";
//   static String zh_ymd = "yyyy年MM月dd日";
//   static String zh_ym = "yyyy年MM月";
//   static String zh_md = "MM月dd日";
//   static String zh_md_hm = "MM月dd日 HH时mm分";
//   static String zh_hms = "HH时mm分ss秒";
//   static String zh_hm = "HH时mm分";
// }
//
...
//
//   /// 返回 年月日星期
//   static String getZHYMDWeekDay(DateTime time) {
//     return "${getDateStrByDateTime(time, format: DateFormat.ZH_YEAR_MONTH_DAY)} ${getZHWeekDay(time)}";
//   }
//
//   /// 返回 年月日星期
//   static String getYMDWeekDay(DateTime time) {
//     return "${getDateStrByDateTime(time, format: DateFormat.YEAR_MONTH_DAY)} ${getWeekDay(time)}";
//   }
//
//   /// 返回相隔天数,[Correction]改正数
...
//   }
//
//   static bool isQinMing(DateTime dt) =>
//       getSpringEquinoxData(dt).add(const Duration(days: 15)) ==
